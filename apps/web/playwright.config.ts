  ...
  webServer: {
    ...
    env: {
      ...
      NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY:
        ...
        `pk_test_${Buffer.from(`127.0.0.1:${port}import { defineConfig, devices } from '@playwright/test';
...
export default defineConfig({
  ...
  webServer: {
    ...
    env: {
      ...
      CLERK_SECRET_KEY: process.env.CLERK_SECRET_KEY ?? 'sk_test_mock_12345678901234567890',
