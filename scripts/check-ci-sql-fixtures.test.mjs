...
const projectionMigration = readFileSync('apps/web/prisma/migrations/20260717020000_add_asset_embedding_owner_visibility/migration.sql', 'utf8');
const backfillMigration = readFileSync('apps/web/prisma/migrations/20260717021000_backfill_asset_embedding_owner_visibility/migration.sql', 'utf8');
const enforcementMigration = readFileSync('apps/web/prisma/migrations/20260717022000_enforce_asset_embedding_owner_visibility/migration.sql', 'utf8');
const finalizationMigration = readFileSync('apps/web/prisma/migrations/20260717022100_finalize_asset_embedding_owner_visibility/migration.sql', 'utf8');
